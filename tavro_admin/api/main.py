...
from api.routers import connectors, docker_logs, env_config, business_applications, companies, lookup, digital_twin
...
app.include_router(lookup.router,                prefix="/api/v1/admin",       tags=["Reference Tables"])
app.include_router(digital_twin.router,          prefix="/api/v1/admin",       tags=["Digital Twin"])
