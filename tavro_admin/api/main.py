...
from api.routers import connectors, docker_logs, env_config, business_applications, companies, datahub_catalog
...
app.include_router(datahub_catalog.router,       prefix="/api/v1/admin",       tags=["Integrations"])
