...
class GeminiConnector(BaseConnector):
    ...
    def validate_config(self):
        ...
        if not self.config.get("auth_code"):
            raise ValueError(
                "auth_code is required. Click 'Get Authorization URL', authorize with Google, then paste the code."
            )
    ...
    def authenticate(self):
        ...
        flow.fetch_token(code=self.config["auth_code"])
    ...
    def execute(self):
        ...
        save_agent_cards("gemini", agent_cards)
