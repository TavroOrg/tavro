...
import { Plug, Settings, ChevronLeft, ChevronRight, LogOut, Terminal, Layers, Building2, Server } from 'lucide-react';
    ...
    return (
        <div className="h-screen overflow-hidden bg-slate-100 dark:bg-slate-950 flex transition-colors">
            ...
            >
                ...
                {/* Collapse toggle â€” floating button at right edge */}
                <button
