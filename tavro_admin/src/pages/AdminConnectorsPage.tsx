                ...
                {isShared && provider.sharedFields && (
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                onClick={() => loadCredentials(sharedConnId)}
                                className="flex items-center gap-2 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 font-semibold px-4 py-2 rounded-xl text-sm transition-all border border-slate-200 dark:border-slate-700"
                            >
                ...
                {!isShared && activeCaps[0]?.fields && (
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button onClick={() => loadCredentials(activeCaps[0].connectorId)} className="flex items-center gap-2 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 font-semibold px-4 py-2 rounded-xl text-sm transition-all border border-slate-200 dark:border-slate-700">
                                <RotateCcw size={14} /> Reset
                            </button>
                        </div>
                    </div>
