...
LOOKUP_DEFAULTS: List[LookupDefault] = [
    ...
    ("ai_use_cases", "priority", "1 - Critical", "1 - Critical", 1, True),
    ...
    # ai_models.provider
    ("ai_models", "provider", "OpenAI", "OpenAI", 1, True),
    ...
    ("ai_models", "model_type", "Large Language Model (LLM)", "Large Language Model (LLM)", 1, True),
    ...
    ("ai_models", "technique_class", "Transformer", "Transformer", 1, True),
    ...
    ("ai_models", "learning_approach", "Supervised", "Supervised", 1, True),
    ...
    ("ai_models", "automation_level", "Human-in-the-loop (HITL)", "Human-in-the-loop (HITL)", 1, True),
    ...
    ("ai_models", "update_frequency", "Real-time/Continuous", "Real-time/Continuous", 1, True),
    ...
    # ai_models.status
    ("ai_models", "status", "Ideation", "Ideation", 1, True),
    ...
    ("ai_models", "emergency_tier", "Mission Critical", "Mission Critical", 1, True),
    ...
    ("ai_models", "business_criticality", "High", "High", 1, True),
    ...
    ("agent_data_sources", "access_level", "Read-Only", "Read-Only", 1, True),
    ...
    ("agent_data_sources", "source_object_type", "Database Table", "Database Table", 1, True),
    ...
    ("agent_data_sources", "target_object_type", "Object Storage", "Object Storage", 1, True),
    ...
    ("compliance_item", "industry_tags", "banking", "banking", 1, True),
    ...
    ("compliance_item", "issuing_body", "FinCEN", "FinCEN", 1, True),
    ...
    ("compliance_impact", "impact_type", "financial", "financial", 1, True),
    ...
    ("business_applications", "emergency_tier", "Mission Critical", "Mission Critical", 1, True),
    ...
    ("business_applications", "business_criticality", "High", "High", 1, True),
    ...
    ("business_processes", "regulatory_impact", "Restricted", "1", 1, True),
    ...
    ("business_processes", "reputational_impact", "Toxic", "1", 1, True),
    ...
    ("business_processes", "process_health_state", "Stable", "Stable", 1, True),
    ...
    ("business_integrations", "emergency_tier", "Mission Critical", "Mission Critical", 1, True),
    ...
    ("business_integrations", "business_criticality", "High", "High", 1, True),
    ...
    ("business_integrations", "protocol", "REST", "REST", 1, True),
    ...
    ("business_integrations", "authentication_method", "OAuth2", "OAuth2", 1, True),
    ...
    ("business_integrations", "data_sensitivity", "None", "None", 1, True),
    ...
    ("business_integrations", "availability_status", "Active", "Active", 1, True),
