...
-- =============================================================
-- 5. APACHE AGE GRAPH  — mirror key edges into Cypher graph
...
-- Seed DimNodes into the graph (label = dim category for easy traversal)
SELECT * FROM ag_catalog.cypher('twin_graph', $$
    UNWIND [
        {id:'a2000000-0000-0000-0000-000000000001', label:'BankUnited Corporate Profile',       type:'Profile'},
        {id:'a3000000-0000-0000-0000-000000000001', label:'Commercial Loan Growth Strategy',    type:'Strategy'},
        {id:'a3000000-0000-0000-0000-000000000002', label:'Digital Banking Modernisation',      type:'Strategy'},
        {id:'a3000000-0000-0000-0000-000000000003', label:'Enterprise Risk Appetite Refresh',   type:'Strategy'},
        {id:'a3000000-0000-0000-0000-000000000004', label:'Deposit Funding Diversification',    type:'Strategy'},
        {id:'a4000000-0000-0000-0000-000000000001', label:'Community Banking Division',         type:'Organisation'},
        {id:'a4000000-0000-0000-0000-000000000002', label:'Commercial Banking Division',        type:'Organisation'},
        {id:'a4000000-0000-0000-0000-000000000003', label:'Multifamily Lending Division',       type:'Organisation'},
        {id:'a4000000-0000-0000-0000-000000000004', label:'Treasury & Capital Markets',         type:'Organisation'},
        {id:'a4000000-0000-0000-0000-000000000005', label:'Technology & Operations Division',   type:'Organisation'},
        {id:'a5000000-0000-0000-0000-000000000001', label:'Commercial Loan Origination',        type:'Process'},
        {id:'a5000000-0000-0000-0000-000000000002', label:'KYC / CDD Onboarding',              type:'Process'},
        {id:'a5000000-0000-0000-0000-000000000003', label:'Credit Risk Review & Grading',       type:'Process'},
        {id:'a5000000-0000-0000-0000-000000000004', label:'Treasury Management Account Opening',type:'Process'},
        {id:'a5000000-0000-0000-0000-000000000005', label:'Regulatory Complaint Management',    type:'Process'},
        {id:'a5000000-0000-0000-0000-000000000006', label:'Regulatory Reporting (Call Report)', type:'Process'},
        {id:'a6000000-0000-0000-0000-000000000001', label:'FIS Horizon Core Banking',           type:'Application'},
        {id:'a6000000-0000-0000-0000-000000000002', label:'Salesforce Financial Services Cloud',type:'Application'},
        {id:'a6000000-0000-0000-0000-000000000003', label:'Digital Banking Platform',           type:'Application'},
        {id:'a6000000-0000-0000-0000-000000000004', label:'nCino Loan Management System',       type:'Application'},
        {id:'a6000000-0000-0000-0000-000000000005', label:'Moodys RiskCalc / CreditLens',       type:'Application'},
        {id:'a6000000-0000-0000-0000-000000000006', label:'Enterprise Data Warehouse (Snowflake)',type:'Application'},
        {id:'a6000000-0000-0000-0000-000000000007', label:'Actimize AML / Transaction Monitoring',type:'Application'},
        {id:'a7000000-0000-0000-0000-000000000001', label:'Hybrid Cloud Infrastructure',        type:'Technology'},
        {id:'a7000000-0000-0000-0000-000000000002', label:'API Gateway & Integration Layer',    type:'Technology'},
        {id:'a7000000-0000-0000-0000-000000000003', label:'Data & Analytics Platform',          type:'Technology'},
        {id:'a7000000-0000-0000-0000-000000000004', label:'Cybersecurity Programme',            type:'Technology'},
        {id:'a8000000-0000-0000-0000-000000000001', label:'CRE Concentration Risk',             type:'Risk'},
        {id:'a8000000-0000-0000-0000-000000000002', label:'Interest Rate Risk',                 type:'Risk'},
        {id:'a8000000-0000-0000-0000-000000000003', label:'Cybersecurity & Data Breach Risk',   type:'Risk'},
        {id:'a8000000-0000-0000-0000-000000000004', label:'Regulatory & Compliance Risk',       type:'Risk'},
        {id:'a8000000-0000-0000-0000-000000000005', label:'Operational Risk',                   type:'Risk'},
        {id:'a8000000-0000-0000-0000-000000000006', label:'Liquidity Risk',                     type:'Risk'}
    ] AS node
    CREATE (:DimNode {id: node.id, label: node.label, type: node.type})
$$) AS (result ag_catalog.agtype);

-- Seed edges into the graph
-- (representative sample — application layer syncs the full set)
SELECT * FROM ag_catalog.cypher('twin_graph', $$
    UNWIND [
        {s:'a3000000-0000-0000-0000-000000000002', t:'a4000000-0000-0000-0000-000000000005', r:'OWNED_BY',   w:0.9},
        {s:'a3000000-0000-0000-0000-000000000001', t:'a8000000-0000-0000-0000-000000000001', r:'RISKS',      w:0.8},
        {s:'a3000000-0000-0000-0000-000000000002', t:'a8000000-0000-0000-0000-000000000003', r:'RISKS',      w:0.7},
        {s:'a4000000-0000-0000-0000-000000000002', t:'a5000000-0000-0000-0000-000000000001', r:'OWNED_BY',   w:0.9},
        {s:'a5000000-0000-0000-0000-000000000001', t:'a6000000-0000-0000-0000-000000000004', r:'DEPENDS_ON', w:0.9},
        {s:'a5000000-0000-0000-0000-000000000003', t:'a6000000-0000-0000-0000-000000000005', r:'DEPENDS_ON', w:0.9},
        {s:'a5000000-0000-0000-0000-000000000006', t:'a6000000-0000-0000-0000-000000000001', r:'DEPENDS_ON', w:1.0},
        {s:'a8000000-0000-0000-0000-000000000001', t:'a5000000-0000-0000-0000-000000000003', r:'GOVERNED_BY',w:0.9},
        {s:'a8000000-0000-0000-0000-000000000003', t:'a6000000-0000-0000-0000-000000000001', r:'RISKS',      w:0.9},
        {s:'a6000000-0000-0000-0000-000000000001', t:'a7000000-0000-0000-0000-000000000002', r:'DEPENDS_ON', w:0.7},
        {s:'a6000000-0000-0000-0000-000000000006', t:'a7000000-0000-0000-0000-000000000003', r:'PART_OF',    w:1.0}
    ] AS e
    MATCH (s:DimNode {id: e.s}), (t:DimNode {id: e.t})
    CREATE (s)-[:RELATED_TO {rel_type: e.r, weight: e.w}]->(t)
$$) AS (result ag_catalog.agtype);
...
-- =============================================================
-- Count by dim category:
-- SELECT t.category, count(*) FROM twin.dim_node n
-- JOIN twin.dim_type t ON t.id = n.dim_type_id
-- WHERE n.company_id = 'a1000000-0000-0000-0000-000000000001'
-- GROUP BY t.category ORDER BY count(*) DESC;

-- Top edges by weight:
-- SELECT s.label, e.rel_type, tgt.label, e.weight
-- FROM twin.dim_edge e
-- JOIN twin.dim_node s   ON s.id = e.source_id
-- JOIN twin.dim_node tgt ON tgt.id = e.target_id
-- WHERE e.valid_to IS NULL ORDER BY e.weight DESC LIMIT 20;

-- Cypher: what does CRE Concentration Risk connect to?
-- SELECT * FROM ag_catalog.cypher('twin_graph', $$
--     MATCH (r:DimNode {label:'CRE Concentration Risk'})-[e]->(n)
--     RETURN r.label, e.rel_type, n.label, e.weight
-- $$) AS (source agtype, rel agtype, target agtype, weight agtype);
