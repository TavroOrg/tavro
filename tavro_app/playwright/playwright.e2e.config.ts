...
export default defineConfig({
  ...
  projects: [
    ...
    {
      // portal-ui-ux.spec.ts creates its own fixture records (Agent, AI
      // Model, Use Case, Application, Process, Integration) in a
      // `beforeAll` hook, held in memory for the run — no separate project,
      // no intermediate JSON file to go stale. See the top of that file.
      name: 'chromium',
      use: {
