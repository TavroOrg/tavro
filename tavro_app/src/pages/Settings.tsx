                        ...
                        <div className="flex items-center justify-between mb-3">
                            <div>
                                ...
                                <p className="text-xs text-slate-400 mt-0.5">
                                    Score = (BV × {(roadmapCfg.priorityWeights.BV * 100).toFixed(0)}%) + ((6−Effort) × {(roadmapCfg.priorityWeights.TC * 100).toFixed(0)}%) − (Risk × {(roadmapCfg.priorityWeights.RISK * 100).toFixed(0)}%)
                                </p>
                            </div>
