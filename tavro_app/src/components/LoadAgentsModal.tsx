            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 w-full max-w-lg flex flex-col">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-slate-800">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-base font-bold text-slate-800 dark:text-slate-100">Load Agents</h2>
                            <p className="text-xs text-slate-500 dark:text-slate-400">Upload agent JSON files to the catalog</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                        ...
                        >
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">
                                    Single or multiple <code className="bg-slate-200 dark:bg-slate-700 px-1 rounded text-[10px]">.json</code> files · Each file may contain one or many agents
                                </p>
                            </div>
                            <input
                                ref={fileInputRef}
...
export default LoadAgentsModal;
